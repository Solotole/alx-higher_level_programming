...
class TestBaseclacc(unittest.TestCase):
    def base1(self):
        b1 = Base()
    ...
    def test_insatnce_id(self):
        b1 = Base(80)
        b1.id = 100
        self.assertEqual(b1.id, 100)

    def test_dictionary_id(self):
        self.assertEqual({'x': 1, 'y': 90, 'z': 78}, Base({'x': 1, 'y': 90, 'z': 78}).id)

    def test_string_id(self):
        self.assertEqual("jon snow", Base("jon snow").id)

    def test_list_id(self):
        self.assertEqual([1, 8, 9], Base([1, 8, 9]).id)

    def test_float_id(self):
        self.assertEqual(4.34, Base(4.34).id)

    def test_tuple_id(self):
        self.assertEqual((3, 7 , 8), Base((3, 7, 8)).id)
